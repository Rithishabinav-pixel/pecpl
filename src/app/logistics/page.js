...
<div className={style.content}>
    <h2 className='heading common_heading'>Road</h2>
<p>Our facility is strategically located along a major National Highway, ensuring seamless road access to key industrial hubs across India. The route is free from flyover or bridge restrictions, enabling hassle-free movement of extra-long or over-height equipment.</p>
...
<div className={style.image}>
  ...
  <div className={`top_content center ${style.top_content}`}>
          <h2 className="common_heading heading">Sea</h2>
          <p>Located approximately 45 km from the Chennai Sea Port, the facility is well connected by highway. Depending on the equipment’s weight and size, shipments are transported using either mechanical or multi-axle hydraulic trailers.</p>
        </div>
...
<div className={style.card}>
    <h2 className='common_heading heading'>ODC Shipments</h2>
    <p>With extensive experience in handling Over-Dimensional Cargo (ODC), the company has a dedicated logistics team that collaborates with reputed service providers. The team ensures smooth execution by selecting the right mode of transport, conducting route surveys, and escorting equipment to its final destination.</p>
    <Image src="/assets/images/odc-img.webp" width={700} height={466} alt='Over-Dimensional Cargo (ODC) shipment'/>
</div>

<div className={style.card}>
    <h2 className='common_heading heading'>Shipping Coordination</h2>
    <p>Custom transportation drawings are prepared and submitted to the customer for approval, detailing packing and lashing requirements. On request, weekly traffic updates are provided until the cargo reaches its destination.</p>
    <Image src="/assets/images/shipping-img.webp" width={700} height={466} alt='Shipping coordination and transport planning'/>
</div>
