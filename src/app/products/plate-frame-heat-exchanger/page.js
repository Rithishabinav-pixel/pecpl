...
<section className={`${style.technicalSection} gray_section`}>
  <div className={`container ${style.container}`}>
    ...
    <div className={style.technicalChart}>
      <Image src={productsData?.[0]?.technicalChart} width={1721} height={1466} alt=''/>
    </div>
    <div className={style.technicalImage}>
      <Image src={productsData?.[0]?.technicalImage} width={1721} height={1466} alt=''/>
    </div>
...
<section className={`${style.pheSection}`}>
  <div className={`container ${style.container}`}>
    ...
    <div className={style.pheContainer}>
      <div className={style.image}>
        <Image src={productsData?.[0]?.phe?.[0]?.image} width={761} height={536} alt="" />
      </div>
